...
const resolvers = {
    ...
    Query: {
        ...
        messages: (_, args) => __awaiter(this, void 0, void 0, function* () {
            ...
            const cursor = messages.length >= MESSAGE_PAGE_LENGTH
        ...
        moreMessages: (_, args) => __awaiter(this, void 0, void 0, function* () {
            ...
            const newCursor = messages.length >= MESSAGE_PAGE_LENGTH
                ? messages[messages.length - 1].order
                : null;
            console.log("messages in moreMessages: ", messages);
        ...
        moreQueue: (_, args) => __awaiter(this, void 0, void 0, function* () {
            ...
            return session
                ...
                const newCursor = list.length >= QUEUE_PAGE_LENGTH
    ...
    User: {
        ...
        queue: (parentValue, _) => queue_1.getQueue(parentValue)
    },
    DateItem: {
        bids: (parentValue, _) => {
            return session
    ...
    Mutation: {
        ...
        editUserQueue: (_, args) => __awaiter(this, void 0, void 0, function* () {
            ...
            let result;
            try {
                result = yield queue_1.getQueue(args.id);
            }
            catch (e) {
                console.log("editUserQueue error: ", e);
                return null;
