...
const index_1 = require("../../../../../src/apollo/queries/index");
...
describe('Query.user', () => {
    ...
    it(`CHECK_EMAIL id: ${TEST_ID}`, () => __awaiter(this, void 0, void 0, function* () {
        const res = yield query({ query: index_1.CHECK_EMAIL, variables: { id: TEST_ID } });
        expect(res).toMatchSnapshot();
    }));
    it('CHECK_EMAIL no params', () => __awaiter(this, void 0, void 0, function* () {
        const res = yield query({ query: index_1.CHECK_EMAIL });
        expect(res).toMatchSnapshot();
    }));
});
