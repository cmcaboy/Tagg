...
const index_1 = require("../../../../../src/apollo/mutations/index");
...
describe('Mutation ', () => {
    ...
    it('NEW_USER', () => __awaiter(this, void 0, void 0, function* () {
        const res = yield mutate({ mutation: index_1.NEW_USER, variables: Object.assign({}, TEST_USER) });
    ...
    it('SET_PUSH_TOKEN', () => __awaiter(this, void 0, void 0, function* () {
        const res = yield mutate({
            mutation: index_1.SET_PUSH_TOKEN,
            variables: {
                id: TEST_USER.id,
                token: '12345',
            },
    ...
    it('CHOOSE_WINNER', () => __awaiter(this, void 0, void 0, function* () {
        const res = yield mutate({
            mutation: index_1.CHOOSE_WINNER,
            variables: {
                id: TEST_USER.id,
                winnerId: TEST_ID,
                dateId: DATE_ID,
    ...
    it('SET_AGE_PREFERENCE', () => __awaiter(this, void 0, void 0, function* () {
        ...
        const res = yield mutate({
            mutation: index_1.SET_AGE_PREFERENCE,
            variables: {
                id: TEST_USER.id,
    ...
    it('SET_NOTIFICATIONS', () => __awaiter(this, void 0, void 0, function* () {
        ...
        const res = yield mutate({
            mutation: index_1.SET_NOTIFICATIONS,
            variables: {
                id: TEST_USER.id,
    ...
    it('SET_FOLLOWER_DISPLAY', () => __awaiter(this, void 0, void 0, function* () {
        ...
        const res = yield mutate({
            mutation: index_1.SET_FOLLOWER_DISPLAY,
            variables: {
                id: TEST_USER.id,
    ...
    it('SET_DESCRIPTION', () => __awaiter(this, void 0, void 0, function* () {
        ...
        const res = yield mutate({
            mutation: index_1.SET_DESCRIPTION,
            variables: {
                id: TEST_USER.id,
